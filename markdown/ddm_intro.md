...
#### 2.2.1 线性数据驱动建模：以 N4SID 为代表的子空间辨识
...
#### 2.2.7 非线性数据驱动建模：基于智能技术的数据驱动建模方法
...
### 3.2 物理引导与频域增强循环网络：面向非线性时空动力学的预测建模
...
### 3.3 基于 LSTM 自编码器与 Normalizing Flows 的非线性系统数据驱动辨识框架
...
### 3.4 基于深度学习的 Koopman 本征函数辨识（Koopman Network）
