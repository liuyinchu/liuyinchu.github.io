...
![使用 mamplot “一键绘图”](/fig/a_new_example.png){.figure-wide}

::: button-row
[Comming Soon ...](https://github.com){.md-button}
[You can visit this page to use mamplotly-web-tools !](https://github.com){.md-button}
:::
...
::: button-row
[Click Here to Visit Its GitHub Repository !](https://github.com/liuyinchu/ysy-data-analysis-helper){.md-button}
:::
