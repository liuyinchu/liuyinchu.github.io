...
<img src="/fig/Little_Horse_Crossing_the_River.png" alt="小马过河" width="40%">

从前，一匹小马和妈妈住在一起。小马渐渐长大了，很想帮妈妈做事。  
一天，马妈妈把一袋麦子放在小马背上，请他送到河对岸的磨坊。小马高兴地答应了，背着麦子出发。走着走着，一条小河挡住了去路。河上没有桥，小马也不知道水有多深，于是站在岸边犹豫起来。  
这时，一头老牛正在河边吃草。小马问：  
“牛伯伯，请问这条河深吗？我能走过去吗？”  
老牛看了看河水，说：  
“不深，水才到我的小腿，你放心过去吧。”  
小马听完，正准备下河。忽然，树上的松鼠急忙跳下来，大声阻止他：  
“别过去！别过去！河水很深，会把你淹死的！前几天，我的一个伙伴就是掉进这条河里被冲走的。”  
小马听后吓了一跳，赶紧收回脚。他感到十分困惑：老牛说河水很浅，松鼠却说河水很深，到底谁说得对呢？  
小马不敢继续前进，只好背着麦子回家。马妈妈看见他回来，问：  
“你怎么没有把麦子送到磨坊？”  
小马把河边发生的事情告诉了妈妈，又问：  
“妈妈，河水到底是深还是浅呢？”  
马妈妈没有直接回答，而是问他：  
“老牛和松鼠的话，你认真想过吗？你自己下河试过吗？”  
小马摇了摇头。  
妈妈耐心地说：  
“别人说的话当然可以参考，但不能只听别人怎么说。老牛那么高大，河水对他来说很浅；松鼠那么矮小，河水对他来说自然很深。你应该自己观察、认真思考，再亲自试一试。不过尝试时也要小心。”  
小马明白了。他再次来到河边，先小心地把一只脚伸进水里，确认水流并不急，然后一步一步向前走。走到河中央时，他发现河水既不像老牛说的那样浅，也不像松鼠说的那样深。对小马而言，水深刚好能够安全通过。  
最后，小马顺利走到河对岸，把麦子送到了磨坊。  
...
::link-card{title="我们的时代中" eyebrow="JOTTINGS" href="/space1/in_our_time"}
<img src="/bg/blog_cover_rainbow_4k.jpg" alt="我们的时代中" width="50%">
::
...
**2026 年 9 月 4 日，GPT-6 Astra 发布，以下小技巧已失效。**
...
- [Figures for Papers](https://github.com/ChenLiu-1996/figures4papers)：这是一个集中存储 Python 脚本的仓库，用于生成高质量的图表。
- [NaturePanelForge](https://github.com/littlepeachs/NaturePanelForge/blob/main/README.zh-CN.md)：NaturePanelForge 是一个 code-first 工作流，用于把真实科学论文图像和开放获取 Nature 系列论文转化为 panel 级别、可执行绘图代码复现任务。
...
- [Karpathy Guidelines](https://github.com/multica-ai/andrej-karpathy-skills/blob/main/skills/karpathy-guidelines/SKILL.md)：减少LLM编码常见错误的行为准则。在编写、审查或重构代码时使用这些准则，可以避免代码过于复杂，进行精准修改，揭示潜在假设，并定义可验证的成功标准。
- [活人感写作](https://github.com/KKKKhazix/human-writing)：让模型写出来的文章读起来像一个具体的人在说话——知道一些事，有判断，偶尔岔开一句，还能接回来。适用于知乎回答、公众号文章、博客、论坛帖、人物故事、科普、评测、小说、口播等大多数中文写作场景。:badge[用过]{tone="success"}
...
:alert
1. **先说清楚这是什么**：用一句话说明项目的用途、解决的问题和适用场景。
2. **尽早给出使用示例**：放一个简洁、可运行的例子，让读者快速判断是否适合自己。
3. **说明如何安装和使用**：给出安装命令、基本用法，以及必要的环境要求。
4. **交代核心 API**：简明列出主要函数、参数、返回值和重要行为。
5. **补充必要背景**：对缩写、术语或特殊概念提供简短解释或链接。
6. **明确限制和注意事项**：说明不适用场景、已知问题、边界条件和兼容性限制。
7. **写清许可证**：尽早说明授权协议，避免用户集成后才发现不合适。

::

> README 要短，只保留帮助用户快速判断和开始使用的信息。详细文档、长示例、设计说明应放到单独页面。
...
{看到屏幕变黑后继续按，直到出现 Apple 标志 再松手}

这叫强制重新启动，适合手机卡死、无响应、网络异常时用。
::
...
::gallery{columns="2"}
![毕业论文](/fig/Ysy_Thesis_Finished.png)
...
:mark[小时候每次打喷涕，总是在想是谁在想自己，小时候把能想到的人都想遍了，确唯独没有想到那是长大后的自己……]

---

## 鲨鱼咬光缆？

<img src="/fig/internet_infra.jpg" alt="鲨鱼咬光缆" width="40%">

---

## 岁序更迭，骏马将晨。

<img src="/fig/LiuYing_HappyNewYear.JPG" alt="2026 新春吉祥" width="20%">
...
<img src="/bg/Sunny_Robin.jpg" alt="愿你安乐。" width="30%">
...
本图[^1]展示了从传统机器学习到深度学习的典型方法。左侧为主成分分析（PCA）和决策树，分别体现了降维与特征提取、基于层级结构的分类与回归。右侧橙色区域为深度学习模型：包括全连接神经网络、卷积神经网络（CNN）、图神经网络（GNN）、注意力机制与Transformer网络、U-net结构、生成对抗网络（GAN）、变分自编码器（VAE）、扩散模型，以及深度强化学习（DRL）。这些方法覆盖了表示学习、生成建模、序列建模与决策优化等主要方向。

[^1]: 本图来源于 [arXiv2401.02321](https://arxiv.org/abs/2401.02321) 。
...
:alert{type="question" title="这是一个看似简单，其实暗藏逻辑的小问题。"}
...
乍一看，两种说法都有点道理，但仔细分析后会发现，:mark[乙的推理才是对的]。

::alert{type="danger" title="为什么甲的说法错了"}
...
::alert{type="success" title="为什么乙的说法对了"}
...
突然发现这也是旧时代的 Vibe Coding 方法了...

::link-card{title="从聊天框到工作流：AI Agent 工程化使用指南" eyebrow="JOTTINGS" href="/space1/ai_agent_blog"}
<img src="/bg/random_gradient_blue_1.jpg" alt="从聊天框到工作流：AI Agent 工程化使用指南" width="50%">
::
...
[^2]: 图片来源于[Astronomy and Space Blog](https://astronomyandspace.blogspot.com/2009/12/solar-system-gravity-wells.html) 。