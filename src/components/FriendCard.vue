...
.friend-card:hover {
  ...
  border-color: rgba(var(--ctp-mocha-teal-rgb), 0.34);
  box-shadow:
    16px 18px 34px rgba(0, 0, 0, 0.38),
    -12px -12px 26px rgba(255, 255, 255, 0.028),
...
.friend-card:hover .avatar {
  ...
  border-color: rgba(var(--ctp-mocha-teal-rgb), 0.42);
}
