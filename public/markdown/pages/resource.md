...
<nav class="md-mini-toc" aria-label="资源目录">
  <strong>快速前往</strong>
  <a href="#sec-query">查询、百科类</a>
  <a href="#sec-python">Python</a>
  <a href="#sec-rust">Rust</a>
  <a href="#sec-computer">电脑相关</a>
  <a href="#sec-notes">一些资料</a>
  <a href="#sec-tools">工具推荐</a>
  <a href="#sec-books">书籍推荐</a>
  <a href="#sec-others">其它</a>
</nav>
...
- [自用 Python API reference for plotly](https://plotly.com/python-api-reference/)
...
### [非常详细的天文科研（入门）指南](https://gitlab.com/dr-guangtou/taotie/blob/master/research/getting_started_cn.md)
如题。
...
这份笔记合集是基于我们固体物理老师（中山大学物理与天文学院俞弘毅教授）上课内容和课件整理而成的，由 2021 级学长整理，对我很有帮助。

### [知乎笔记：如何在 LaTeX 中编写算法伪代码](https://zhuanlan.zhihu.com/p/266241159)。
省流：LaTeX 中算法伪代码请用相应的宏包：algorithm 和 algorithmic ；（省下的让 AI 搞定）建议还是去看看笔记原文，不是很复杂。

<h2 id="sec-tools" class="sec">工具推荐 <a href="#top" class="back-top">TOP ↑</a></h2>
